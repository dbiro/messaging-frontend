...
namespace Sixeyed.MessagingPoweredFrontEnd.QueueCore
{
    /// <summary>
    ...
    public class Queue : IDisposable
    {
        ...
        public Queue(string host, bool createReplyQueue = false)
        {            
            var factory = new ConnectionFactory();
            factory.Uri = new Uri("amqp://guest:guest@" + host + ":5672/");
